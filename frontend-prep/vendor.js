requirejs.config({
        ...
        paths: {
            ...
            jZoom: "libs/jquery/zoom",
            reel: "libs/jquery/jquery.reel",
            scrollTo: "libs/tweenmax/ScrollToPlugin.min",
            select: "libs/jquery/jquery.selectric.min",
            ...
            loadMore: "utils/load-more",
            breakpoints: "utils/breakpoints",
            cookies: "utils/cookies",
            dispatcher: "utils/dispatcher",
            forceRepaint: "utils/force-repaint",
            forms: "utils/forms",
            ...
            scrollToElement: "utils/scroll-to-element",
            simpleAccordion: "utils/simple-accordion",
            productpush: "utils/product-push",
            fontLoader: "modules/font-loader",
            system: "modules/system",
            accordion: "modules/accordion",
            accountDataCards: "modules/account-data-cards",
            accountLanding: "modules/account-landing",
            addressBook: "modules/address-book",
            accountSettings: "modules/account-settings",
            addProductShoppingBag: "modules/add-product-shopping-bag",
            addProductShoppingBagFlyout: "modules/add-product-shopping-bag-flyout",
            addMergedProductShoppingBag: "modules/add-merged-product-shopping-bag",
            removeProductShoppingBag: "modules/remove-product-shopping-bag",
            breadcrumbs: "modules/breadcrumbs",
            capsule: "modules/capsule",
            capsuleLooksGrid: "modules/capsule-looks-grid",
            capsuleProductsGrid: "modules/capsule-products-grid",
            careersNav: "modules/careers-nav",
            slickCarousel: "modules/slick-carousel",
            carouselScrollSpy: "modules/carousel-scroll-spy",
            changeEmail: "modules/change-email",
            changePassword: "modules/change-password",
            checkout: "modules/checkout",
            checkoutFooter: "modules/checkout-footer",
            checkoutGifting: "modules/checkout-gifting",
            checkoutLogin: "modules/checkout-login",
            checkoutPayment: "modules/checkout-payment",
            checkoutShipping: "modules/checkout-shipping",
            clientServices: "modules/client-services",
            confirmPassword: "modules/confirm-password",
            contactUs: "modules/contact-us",
            collection: "modules/collection",
            copyLink: "modules/copy-link",
            createAccount: "modules/create-account",
            deleteAccount: "modules/delete-account",
            datePickerModule: "modules/datepicker",
            dropdownFlags: "modules/dropdown-flags",
            filterBar: "modules/filter-bar",
            filterCategory: "modules/filter-category",
            filterCategoryLevel: "modules/filter-category-levels",
            filterSort: "modules/filter-sort",
            findInStore: "modules/find-in-store",
            ...
            heroCountdown: "modules/hero-countdown",
            heroLarge: "modules/hero-large",
            jsonHtml: "modules/json-html",
            looksDetailCarousel: "modules/looks-detail-carousel",
            mayWeHelp: "modules/may-we-help",
            overlay: "modules/overlay",
            overlayHideShow: "modules/overlay-hide-show",
            overlayCancelOrder: "modules/overlay-cancel-order",
            overlayCancelItem: "modules/overlay-cancel-item",
            orderHistory: "modules/order-history",
            overlayShareByEmail: "modules/overlay-share-by-email",
            personalizationOverlay: "modules/personalization-overlay",
            productDetail: "modules/product-detail",
            productDetailScrollSpy: "modules/product-detail-scroll-spy",
            productSizes: "modules/product-sizes",
            savedItems: "modules/saved-items",
            emailSavedItems: "modules/email-saved-items",
            resetPassword: "modules/reset-password",
            savedItemsFlyout: "modules/saved-items-flyout",
            savedItemsSave: "modules/saved-items-save",
            scheduleAppointment: "modules/schedule-appointment",
            searchFlyout: "modules/search-flyout",
            signIn: "modules/sign-in",
            signInAjax: "modules/sign-in-ajax",
            signInSalesAssistant: "modules/sign-in-sales-assistant",
            simpleTabs: "modules/simple-tabs",
            styleSelector: "modules/style-selector",
            sizeGuideOverlay: "modules/size-guide-overlay",
            storeDetails: "modules/store-details",
            storeLocator: "modules/store-locator",
            shoppingBag: "modules/shopping-bag",
            shopTheLookCarousel: "modules/shop-the-look-main-carousel",
            shopTheLook: "modules/shop-the-look",
            storesMap: "modules/stores-map",
            story: "modules/story",
            subscribe: "modules/subscribe",
            tableOfContents: "modules/table-of-contents",
            tabs: "modules/tabs",
            takeoverMosaic: "modules/takeover-mosaic",
            thankYouNewsletter: "modules/thank-you-newsletter",
            tooltip: "modules/tooltip",
            unacceptedOrder: "modules/unaccepted-order",
            unsubscribe: "modules/unsubscribe",
            upcomingEvents: "modules/upcoming-events",
            validatorForm: "modules/validator-form",
            video: "modules/video",
            view360: "modules/view-360",
            walletCreditCard: "modules/wallet-credit-card",
            yourAccount: "modules/your-account",
            cardCarousel: "modules/card-carousel",
            overlaySlideShow: "modules/overlay-slide-show",
            faq: "modules/faq",
            zoom: "modules/product-zoom",
            billingAddress: "modules/billing-address",
            creditCardValidation: "modules/credit-card-validation",
            basket: "modules/basket",
            ajaxProductDetails: "utils/ajax_productDetails",
            cookiedirectivepolicy: "modules/cookiedirectivepolicy",
            theEdit: "modules/the-edit",
